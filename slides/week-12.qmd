...
The transformer architecture was introduced only in 2017!! This paper revolutionized many natural language processing task, particularly, machine translation and language modelling. All famous models of today are based in the transformers framework
...
So, you will ver likely:

-   use pre-trained models available on the web.
