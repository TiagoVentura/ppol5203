...
```{r  echo=FALSE, out.width = "80%", fig.align="center"}
knitr::include_graphics("week1_figs/gpt.png") 
```

## As a consequence, we live in a world:

-  **With** abundance of data we can use for research and policy decisions:
...
-   Part of a larger and new field called [computational social science](https://en.wikipedia.org/wiki/Computational_social_science)
...
## Course Schedule{style="font-size: .8em;"}
...
-   **Datacamp**: Additional exercises! Access our free account [here](https://www.datacamp.com/groups/shared_links/30765dd1c783b864ab9ad885cb08a129b7113054664cddb1446f4e3d46b4605d)
