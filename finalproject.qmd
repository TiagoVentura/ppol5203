...
-   Before October 31, your should have met with me to discuss your proposal.
...
Also remember to add when you want meet with me. You can pick any of the office hours time (Tuesdays between 4-6pm). If the office hours do not work for you, let me know and we will find a solution.
...
-   All codes used to generate the results of your final project

-   Your proposal

-   A README for the repository that describes in detail all files in the repository. The README should describe:

    -   Inputs of your project: e.g., raw data; a file containing credentials needed to access an API

    -   What each code does: describe major transformations.

    -   Main outputs: if the file produces any outputs (e.g., a cleaned dataset; a figure or graph).

    -   Title and abstract of your project.

Remember to check examples from the first class about a README for a published article should look like.
...
Here, I suggest a few templates for writing your reports. In my experience, writing data science reports using [LaTeX](https://towardsdatascience.com/latex-for-data-scientists-in-under-6-minutes-3815d973c05c) is an gain in productivity in the long-run.

If you want to experiment with LaTeX via overleaf, you can also use the [Journal of Quantitative Description templates](https://journalqd.org/jqdtemplate) in Word Doc or LaTeX:
...
Here you can download some examples from projects from last year of DSPP students. Those are good projects, and involve both skills students learned in class + skills learned in other classes (like causal inference techniques). There are issue with these projects, so take them as references, not as a rubric.

[PPOL 5203 Projects 2022](./projects_ppol2022.zip)

[PPOL 5203 Projects 2023](./2023.zip)

[PPOL 5203 Projects 2024](./2024.zip)
